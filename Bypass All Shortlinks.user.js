...
// @include /^(https?:\/\/)(.+)?(claimcrypto|1ink|linkpay|moneylink|linkspy|linx|adurly|getlink|stfly|goldly|insurancly|forexly)(\.cc)(\/.*)/
...
(function() { // Please Remember , My Scripts is better with Firefox Browser and Violentmonkey Extension
  ...
  function SubmitBp(selector, time) {setTimeout(()=>{let elem = typeof selector === 'string' ? bp(selector).closest('form') : selector; elem.dispatchEvent(new Event('submit')).submit();}, time*1000);}
  ...
  function onHtmlLoaded() {
    ...
    BypassedByBloggerPemula(/mdn.lol/, function() {EnableRCF();BypassHD('input[type=hidden]', 17);});
    ...
    BypassedByBloggerPemula(/mobi2c.com|newforex.online|healthy4pepole.com|hightrip.net|world-trips.net|healdad.com|world2our.com|otechno.net|mobitaak.com|forexit.online|bluetechno.net|te-it.com/, function() {
